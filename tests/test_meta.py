...
class Test_MetaData(unittest.TestCase):
    ...
    def test_best_meta(self):
        ...
        assert sorted(best_meta_inf.keys()) == sorted(['second', '4', 'dup', 'first', 'neg'])
        ...
        assert len(best_meta_231) == len(self.dat)-3 # one duplicate and first and neg
        ...
        assert sorted(best_meta_neg.keys()) == sorted(['first', 'second', 'dup', '4', 'neg'])
