...
class Test_StaticMetaUnzipped(unittest.TestCase):
    ...
    def test_read_metadata(self):
        ...
        assert self.file.check_metadata(filter_meta_dict={'lc_2005': 130,
                                                          'climate_KG': 'Cfa',
                                                          'sand_fraction': 36.})
    ...
    def test_metadata_for_depth(self):
        ...
        meta_for_depth = allmeta.best_meta_for_depth(Depth(0., 0.21))
        ...
        assert meta_for_depth['saturation'].depth.start == meta_for_depth['sand_fraction'].depth.start == 0.
        assert meta_for_depth['saturation'].depth.end == meta_for_depth['sand_fraction'].depth.end ==  0.3
